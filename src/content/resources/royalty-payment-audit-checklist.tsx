  ...
  return (
    <div className="prose-content">
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        the wellhead and the point of sale all contribute to mineral owners
        receiving less than they are owed. The Oklahoma Royalty Payment Act at
        Title 52, Section 570.1 et seq. requires operators to pay royalties
        within specific timeframes and imposes penalties for late or deficient
        payments. But the statute only helps if you know you are being
        underpaid. This checklist walks you through the process of verifying
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        3/16ths royalty on 40 net mineral acres in a 640-acre spacing unit, your
        decimal interest should be 0.01171875. Errors in decimal interest are
        one of the most frequent causes of underpayment, and they compound every
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        records through the OCC's online well records search at the OCC
        Imaging System. Pull the production data for your well going back at
        least 12 months. Record the monthly oil volumes (in barrels) and gas
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        assessed on the gross value of production at the wellhead. The
        purchaser's report will show the volume purchased each month and the
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        result from measurement tolerances and meter calibration timing.
        Differences greater than 5 percent warrant investigation. On pricing,
        compare the price per barrel or per MCF on your check stub against the
        purchaser's report and the posted price for the relevant grade of crude
        oil or gas index price for the month. If your check stub shows a price
        significantly below the purchaser's reported price, the operator may be
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        production unless the lease specifically authorizes those deductions. In
        practice, many operators deduct compression, gathering, treating,
        dehydration, and transportation costs from gas royalties. Review your
        check stubs for line items labeled "gathering," "compression,"
        "transportation," "treating," "processing," or "marketing." If your
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        operators attempt to offset surface damage obligations against royalty
        payments. These are separate obligations. Surface damage compensation is
        owed to the surface owner for physical damage to the land. Royalties
        are owed to the mineral owner for production. One does not reduce the
        other.
      </p>
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        spacing units into a single drilling unit, changing your proportionate
        interest. Applications to change operators affect who is responsible for
        paying your royalty. Monitor the OCC docket for applications involving
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        deductions appear on your check stub that were not present before. You
        stop receiving checks entirely for two or more months with no
        explanation. The decimal interest on your check stub changes without any
        new pooling or spacing order. The volumes reported on your check stub
      ...
      <p className="text-gq-light/70 text-base leading-relaxed mb-4">
        ...
        paying royalties after first production and must pay within six months.
        If the operator fails to respond or the accounting does not resolve the
        issue, you may have claims for underpaid royalties, statutory interest
        at 12 percent per annum, and attorney fees. The statute of limitations
