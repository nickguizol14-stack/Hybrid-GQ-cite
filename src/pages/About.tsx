  ...
  return (
    ...
    >
      ...
      <section className="bg-gq-dark-gradient pt-36 sm:pt-44 pb-16 sm:pb-24 relative overflow-hidden">
        ...
        <div className="absolute top-[-20%] right-[-15%] w-[500px] h-[500px] bg-[#C5A869]/5 rounded-full blur-[100px] pointer-events-none" />

        <div className="container-gq relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16 items-center">
            {/* Text */}
            <div>
              <p className="hero-reveal text-[#C5A869] text-xs tracking-[4px] uppercase font-semibold mb-4">About the Attorney</p>
              <h1 className="hero-reveal font-serif text-4xl sm:text-5xl md:text-6xl lg:text-7xl text-gq-light font-medium leading-tight mb-6">
                Gary David <span className="block text-[#C5A869] italic">Quinnett</span>
              </h1>
              ...
              <div className="hero-reveal">
                <Link to="/contact" className="inline-flex btn-primary text-sm py-3 px-8 rounded-lg tracking-wide border border-[#B03A4A]/30">
            ...
            <div className="relative">
              <div className="hero-img rounded-2xl overflow-hidden shadow-2xl border border-[#C5A869]/10 aspect-[3/4] max-w-md mx-auto lg:ml-auto">
      ...
      {/* CREDENTIALS BAR */}
      <section className="bg-[#1A1510] border-y border-[#C5A869]/10">
        <div className="container-gq">
          <div className="grid grid-cols-2 md:grid-cols-4 divide-x divide-[#C5A869]/10 stagger-group">
            {[
              ...
              <div key={i} className="stagger-item p-5 sm:p-6 lg:p-8 text-center">
                ...
                <div className="text-[#C5A869] text-[9px] sm:text-[10px] tracking-[2px] uppercase font-semibold mb-2">{cred.label}</div>
        ...
        <div className="container-gq">
          <div className="max-w-4xl">
            <div className="scroll-reveal">
              <p className="text-[#C5A869] text-xs tracking-[3px] uppercase font-semibold mb-3">The Practice</p>
              <h2 className="font-serif text-3xl sm:text-4xl text-[#1A1510] font-medium mb-6">
                Built on Business, <span className="text-[#C5A869]">Driven by Results</span>
              </h2>
            </div>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
              <div className="scroll-reveal space-y-4 text-[#1A1510]/70 text-base leading-relaxed">
                <p>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gq-dark-gradient relative overflow-hidden">
        ...
        <div className="container-gq relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8 lg:gap-12">
            ...
            {/* Education */}
            <div className="scroll-reveal bg-[#2a2219] border border-[#C5A869]/10 rounded-2xl p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-6">
                <BookOpen className="w-5 h-5 text-[#C5A869]" />
                <h3 className="font-serif text-xl text-gq-light font-medium">Education</h3>
              </div>
              <div className="space-y-6">
                <div className="border-l-2 border-[#C5A869]/30 pl-4">
            ...
            <div className="scroll-reveal bg-[#2a2219] border border-[#C5A869]/10 rounded-2xl p-6 sm:p-8">
              <div className="flex items-center gap-3 mb-6">
                <Briefcase className="w-5 h-5 text-[#C5A869]" />
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-[#FDFBF7]">
        <div className="container-gq">
          <div className="scroll-reveal text-center mb-10 sm:mb-14">
            <p className="text-[#C5A869] text-xs tracking-[3px] uppercase font-semibold mb-3">How We Work</p>
            <h2 className="font-serif text-3xl sm:text-4xl text-[#1A1510] font-medium">Our Principles</h2>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 max-w-5xl mx-auto stagger-group">
            {[
              ...
              <div key={i} className="stagger-item bg-white border border-[#1A1510]/5 rounded-xl p-6 hover:shadow-lg hover:-translate-y-1 transition-all duration-300">
                <div className="flex items-center gap-3 mb-3">
                  <div className="w-8 h-8 rounded-lg bg-[#C5A869]/10 flex items-center justify-center text-[#C5A869] text-xs font-bold font-serif">
                    {String(i + 1).padStart(2, '0')}
                  </div>
                  <h3 className="font-serif text-lg text-[#1A1510] font-medium">{p.title}</h3>
                </div>
                <p className="text-[#1A1510]/60 text-sm leading-relaxed">{p.desc}</p>
              </div>
            ))}
          </div>
        </div>
      ...
      <section className="py-12 sm:py-16 lg:py-24 bg-gq-dark-gradient relative overflow-hidden">
        ...
        <div className="container-gq relative z-10">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-10 lg:gap-16">
            {/* Who We Serve */}
            <div className="scroll-reveal">
              <p className="text-[#C5A869] text-xs tracking-[3px] uppercase font-semibold mb-3">Our Clients</p>
              ...
              <div className="bg-[#2a2219] border-l-2 border-[#C5A869] p-5 rounded-r-lg">
            ...
            {/* Contact Card */}
            <div className="scroll-reveal">
              <div className="bg-[#2a2219] border border-[#C5A869]/10 rounded-2xl p-6 sm:p-8">
                ...
                <div className="space-y-5 mb-8">
                  <a href="tel:405-607-2266" className="flex items-center gap-4 group">
                    <div className="w-10 h-10 rounded-lg bg-[#C5A869]/10 flex items-center justify-center group-hover:bg-[#C5A869]/20 transition-colors">
                      <Phone className="w-4 h-4 text-[#C5A869]" />
                    </div>
                    <div>
                      <div className="text-gq-light font-medium group-hover:text-[#C5A869] transition-colors">(405) 607-2266</div>
                  ...
                  <a href="mailto:gary@gq-law.com" className="flex items-center gap-4 group">
                    ...
                    <div>
                      <div className="text-gq-light font-medium group-hover:text-[#C5A869] transition-colors">gary@gq-law.com</div>
                      <div className="text-gq-light/30 text-xs">Email Gary</div>
                    </div>
                  </a>
                </div>

                <div className="border-t border-[#C5A869]/10 pt-6 space-y-4">
                  <div className="flex items-start gap-4">
                    <MapPin className="w-4 h-4 text-[#C5A869] mt-1 flex-shrink-0" />
                    <div>
                  ...
                  <div className="flex items-start gap-4">
                    <MapPin className="w-4 h-4 text-[#C5A869]/50 mt-1 flex-shrink-0" />
                    <div>
                ...
                <Link
                  to="/contact"
                  className="mt-6 w-full inline-flex items-center justify-center gap-2 btn-primary text-sm py-3 rounded-lg tracking-wide border border-[#B03A4A]/30"
                >
