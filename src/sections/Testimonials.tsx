...
const Testimonials = () => {
  ...
  return (
    ...
    >
      ...
      <div className="absolute top-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#C5A869]/40 to-transparent" />
      <div className="absolute bottom-0 left-0 w-full h-px bg-gradient-to-r from-transparent via-[#C5A869]/40 to-transparent" />
      <div className="absolute top-[-20%] right-[-10%] w-[800px] h-[800px] bg-[#C5A869]/10 rounded-full blur-[120px] pointer-events-none" />
      <div className="absolute bottom-[-20%] left-[-10%] w-[600px] h-[600px] bg-[#9B2D3D]/5 rounded-full blur-[100px] pointer-events-none" />

      <div className="container-gq relative z-10">

        {/* Section Header */}
        <div ref={titleRef} className="text-center mb-10 lg:mb-16">
          <p className="text-[#C5A869] text-sm md:text-base tracking-[0.2em] uppercase font-medium mb-4">
            Client Experiences
          </p>
          <h2 className="font-serif font-medium text-gq-dark text-4xl sm:text-5xl md:text-6xl lg:text-7xl mb-6">
            Trusted by Oklahoma&apos;s <br />
            <span className="text-[#C5A869] italic">Builders & Business Owners</span>
          </h2>
          <div className="w-24 h-1 bg-gradient-to-r from-transparent via-[#C5A869] to-transparent mx-auto opacity-70 rounded-full" />
        </div>
              ...
              {testimonials.map((testimonial, index) => (
                ...
                >
                  <div className="relative h-full bg-white/70 backdrop-blur-md rounded-2xl p-6 sm:p-8 md:p-12 shadow-[0_8px_30px_rgb(0,0,0,0.06)] border border-[#C5A869]/20 group transition-transform duration-500 hover:-translate-y-2">
                    ...
                    <Quote className="absolute top-6 right-8 w-24 h-24 text-[#C5A869]/10 rotate-180 pointer-events-none" />

                    <div className="relative z-10 flex flex-col h-full">
                      <div className="mb-8">
                        <Quote className="w-10 h-10 text-[#C5A869] mb-6 fill-current opacity-80" />
                        <blockquote className="font-serif text-2xl md:text-3xl text-gq-dark/95 leading-relaxed italic">
                      ...
                      <div className="mt-auto pt-6 border-t border-black/5 flex items-center justify-between">
                        <div>
                          <p className="font-sans font-semibold tracking-wide text-gq-dark text-lg">
                            {testimonial.author}
                          </p>
                          <p className="text-[#C5A869] text-xs md:text-sm tracking-widest uppercase mt-1 font-medium">
                            {testimonial.location}
                          </p>
                        </div>
                        {/* Decorative line */}
                        <div className="hidden sm:block w-12 h-px bg-[#C5A869]/40" />
                      </div>
                    </div>
                  </div>
                </div>
        ...
        <div ref={badgesRef} className="max-w-4xl mx-auto">
          <div className="relative p-[1px] rounded-2xl bg-gradient-to-r from-transparent via-[#C5A869]/60 to-transparent shadow-[0_0_30px_rgb(197,168,105,0.15)]">
            <div className="bg-white/90 backdrop-blur-xl rounded-2xl py-8 px-6 sm:px-12 flex flex-col md:flex-row items-center justify-center gap-8 md:gap-14 shadow-[0_8px_30px_rgb(0,0,0,0.08)]">

              <div className="badge-item flex items-center gap-5 group">
                <div className="relative flex-shrink-0">
                  <div className="absolute inset-0 bg-[#C5A869] blur-2xl opacity-20 group-hover:opacity-40 transition-opacity duration-500 rounded-full scale-125" />
                  <img
                ...
                <div>
                  <p className="font-serif font-medium text-gq-dark text-lg sm:text-xl">Lawyers of Distinction</p>
                  <p className="text-[#C5A869] text-xs sm:text-sm tracking-[0.2em] uppercase font-bold mt-1">2021 Recipient</p>
                </div>
              </div>

              {/* Separator Line */}
              <div className="hidden md:block w-px h-20 bg-gradient-to-b from-transparent via-[#C5A869]/30 to-transparent" />
              ...
              <div className="badge-item flex items-center gap-5 group">
                ...
                <div>
                  <p className="font-serif font-medium text-gq-dark text-lg sm:text-xl">Lawyers of Distinction</p>
                  <p className="text-[#C5A869] text-xs sm:text-sm tracking-[0.2em] uppercase font-bold mt-1">2022 Recipient</p>
                </div>
              </div>
            </div>
          </div>
